...
class Build(object):
    ...
    def __init__(self, author=None, base_ref=None, branch=None, clone=None, commit=None, created=None, deploy=None, distribution=None, email=None, enqueued=None, error=None, event=None, finished=None, host=None, id=None, link=None, message=None, number=None, parent=None, ref=None, repo_id=None, runtime=None, sender=None, source=None, started=None, status=None, title=None):  # noqa: E501
